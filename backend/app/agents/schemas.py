...
class GMAction(BaseModel):
    ...
    type: str = Field(
        ...
        description=(
            ...
            "scene_layout | scene_update | scene_progress_update | scene_options_update | "
            "revelation | "
    ...
    target: str | None = Field(None, description="ID du personnage cible, ou null")
...
class GMResponse(BaseModel):
    ...
    inner_reasoning: str | None = Field(
