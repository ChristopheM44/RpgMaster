...
def test_generate_adventure_context_classical_random():
    """La génération classique/aléatoire par défaut produit un dict complet et valide."""
...
def test_generate_adventure_context_with_specific_preset():
    """Le chargement d'un preset d'univers (Pangée, Jungle) applique les bonnes valeurs."""
...
def test_generate_adventure_context_preset_with_overrides():
    """Les surcharges utilisateur fonctionnent même avec un preset d'univers demandé."""
    seed = generate_adventure_context(
...
def test_generate_adventure_context_invalid_options():
    """Le système retombe élégamment sur ses pieds face à des presets/biomes invalides."""
